...
from sqlalcorm.database import DATABASE_URL

from sqlalchemy import create_engine

from sqlalcorm import models
...
print("ALEMBIC sqlalchemy.url BEFORE:", config.get_main_option("sqlalchemy.url"))
...
from sqlalcorm.database import Base  # import your declarative base
